...
const Reports = {
    ...
    level1: [{
        text: 'Attendance Records',
        icon: 'fa fa-users',
        link: '/secure/reports/attendencerecords',
        level2: [
            {
                text: 'Daily Resources Status- Plan Vs Present',
                icon: 'fa fa-users',
                link: '/secure/reports/attendencerecords/dailyresource',
            },
            {
                text: 'Daily Employee Records',
                icon: 'fa fa-users',
                link: '/secure/reports/attendencerecords/dailyemprec',
            },
            {
                text: 'Crew Wise Daily Development List',
                icon: 'fa fa-users',
                link: '/secure/reports/attendencerecords/dailyplan',
            },
            {
                text: 'Daily Plant Records',
                icon: 'fa fa-users',
                link: '/secure/reports/attendencerecords/dailyplantrec',
            },
            {
                text: 'Monthly Employee Records',
                icon: 'fa fa-users',
                link: '/secure/reports/attendencerecords/monthlyemprec',
            },
            {
                text: 'Monthly Plant Records',
                icon: 'fa fa-users',
                link: '/secure/reports/attendencerecords/monthlyplantrec',
            }
        ]
    },
    {
        text: 'Work Dairy',
        icon: 'fa fa-users',
        link: '/secure/reports/workdairy',
        level2: [
            {
                text: 'Work Dairy Search & Its Records',
                icon: 'fa fa-users',
                link: '/secure/reports/workdairy/searchrec',
            }, {
                text: 'Submission and Approval',
                icon: 'fa fa-users',
                link: '/secure/reports/workdairy/submissionapproval',
            }
        ]
    },
    {
    ...
    },
    {
        ...
        icon: 'fa fa-users',
        link: '/secure/reports/costperformance',
        level2: [
            {
                text: 'Create',
                icon: 'fa fa-users',
